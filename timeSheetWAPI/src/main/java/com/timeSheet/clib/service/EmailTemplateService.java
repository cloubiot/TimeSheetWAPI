...
import com.timeSheet.clib.util.TimeSheetUtil;
...
public class EmailTemplateService {
	...
	public String getEmailTemplate(String templateName, Map<String,Object> modelMap){
	      ...
	      Properties props = new Properties();
	     	props.put("file.resource.loader.path", TimeSheetUtil.getConfigDIR()+"/emailTemplate");
	        ...
	        velocity.init(props);
	        System.out.println(TimeSheetUtil.getConfigDIR()+"/emailTemplate/"+templateName);
